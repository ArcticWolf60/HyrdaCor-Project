@echo off
title The Dungeon (Final Project)
cls
color 3f
...
echo (Hint: To navigate menus, just type the number corresponding with the choice you would
echo like to make.)
echo.
...
REM fAsking people if they REALLY want to see the cheats
:Cheats_Confirm
cls
...
echo.
	...
	goto Dungeon_Hall
		...
		echo.
			...
			REM "ping localhost -n 4 >nul" pauses the program for two seconds. I put this here to alow the player enough time to read the text before it advances
